...
```
    ...
    ## ── R CMD INSTALL ───────────────────────────────────────────────────────────────
    ##   ─  installing *source* package 'odinc41e4e70' ... (754ms)
    ...
    ##      installing to C:/Users/SAUDH~1/AppData/Local/Temp/Rtmpqmdmge/devtools_install_47841214365e/00LOCK-file478445053f97/00new/odinc41e4e70/libs/x64
    ##   ─  DONE (odinc41e4e70)
    ## 
...
```
    ...
    ##      installing to C:/Users/SAUDH~1/AppData/Local/Temp/Rtmpqmdmge/devtools_install_478443fe333c/00LOCK-file4784708d7878/00new/odin73e1b272/libs/x64
    ##   ─  DONE (odin73e1b272)
    ## 
...
```
    ...
    ## ── R CMD INSTALL ───────────────────────────────────────────────────────────────
    ##   ─  installing *source* package 'odin7ad0d09b' ... (1s)
    ##      ** using staged installation
    ##      ** libs
    ##      using C compiler: 'gcc.exe (GCC) 13.3.0'
    ##      gcc  -I"C:/PROGRA~1/R/R-44~1.1/include" -DNDEBUG     -I"C:/RBuildTools/4.4/x86_64-w64-mingw32.static.posix/include"     -O2 -Wall -gdwarf-2 -mfpmath=sse -msse2 -mstackrealign  -UNDEBUG -Wall -pedantic -g -O0 -c odin.c -o odin.o
    ...
    ##      installing to C:/Users/SAUDH~1/AppData/Local/Temp/Rtmpqmdmge/devtools_install_478457f02d95/00LOCK-file4784ab84a4e/00new/odin7ad0d09b/libs/x64
    ##   ─  DONE (odin7ad0d09b)
    ## 
...
```
    ...
    ## ── R CMD INSTALL ───────────────────────────────────────────────────────────────
    ##   ─  installing *source* package 'odin57de2361' ... (730ms)
    ##      ** using staged installation
    ##      ** libs
    ##      using C compiler: 'gcc.exe (GCC) 13.3.0'
    ##      gcc  -I"C:/PROGRA~1/R/R-44~1.1/include" -DNDEBUG     -I"C:/RBuildTools/4.4/x86_64-w64-mingw32.static.posix/include"     -O2 -Wall -gdwarf-2 -mfpmath=sse -msse2 -mstackrealign  -UNDEBUG -Wall -pedantic -g -O0 -c odin.c -o odin.o
    ...
    ##      installing to C:/Users/SAUDH~1/AppData/Local/Temp/Rtmpqmdmge/devtools_install_4784149a7823/00LOCK-file47847c6f6b74/00new/odin57de2361/libs/x64
    ##   ─  DONE (odin57de2361)
    ## 
